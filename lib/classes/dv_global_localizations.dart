...
///   * ur - Urdu
///   * dv - Dhivehi
class DvGlobalWidgetsLocalizations implements WidgetsLocalizations {
  /// Construct an object that defines the localized values for the widgets
  /// library for the given `locale`.
  ///
  /// [LocalizationsDelegate] implementations typically call the static [load]
  /// function, rather than constructing this class directly.
  DvGlobalWidgetsLocalizations(this.locale) {
  ...
  static Future<WidgetsLocalizations> load(Locale locale) {
    return SynchronousFuture<WidgetsLocalizations>(DvGlobalWidgetsLocalizations(locale));
  }
...
class _WidgetsLocalizationsDelegate extends LocalizationsDelegate<WidgetsLocalizations> {
  ...
  @override
  Future<WidgetsLocalizations> load(Locale locale) => DvGlobalWidgetsLocalizations.load(locale);
