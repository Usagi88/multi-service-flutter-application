...
/// A custom set of date patterns for the `dv` locale.
///
...
/// A custom set of date symbols for the `dv` locale.
///
...
// #docregion Delegate
class _DvMaterialLocalizationsDelegate
    extends LocalizationsDelegate<MaterialLocalizations> {
  const _DvMaterialLocalizationsDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'dv';

  @override
  Future<MaterialLocalizations> load(Locale locale) async {
    final String localeName = intl.Intl.canonicalizedLocale(locale.toString());

    // The locale (in this case `dv`) needs to be initialized into the custom
    // date symbols and patterns setup that Flutter uses.
    date_symbol_data_custom.initializeDateFormattingCustom(
      locale: localeName,
      patterns: dvLocaleDatePatterns,
      symbols: intl.DateSymbols.deserializeFromMap(dvDateSymbols),
    );

    return SynchronousFuture<MaterialLocalizations>(
      DvMaterialLocalizations(
  ...
  @override
  bool shouldReload(_DvMaterialLocalizationsDelegate old) => false;
}
// #enddocregion Delegate

/// A custom set of localizations for the 'dv' locale. In this example, only
/// the value for openAppDrawerTooltip was modified to use a custom message as
/// an example. Everything else uses the American English (en_US) messages
/// and formatting.
class DvMaterialLocalizations extends GlobalMaterialLocalizations {
  const DvMaterialLocalizations({
    String localeName = 'dv',
...
// #enddocregion Raw
  ...
  _DvMaterialLocalizationsDelegate();
