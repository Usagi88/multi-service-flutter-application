...
class PackageRechargeView extends StatefulWidget {
  final bool? dhiraagu;
  final bool? ooredoo;
  PackageRechargeView({Key? key,
    this.dhiraagu,
    this.ooredoo
  }) : super(key: key);

  @override
  _PackageRechargeViewState createState() => _PackageRechargeViewState();
}
                                              ...
                                              Padding(
                                                ...
                                                child: Align(
                                                    ...
                                                    child: SlideTransition(
                                                      ...
                                                      child: FadeTransition(
                                                        opacity: _animationController,
                                                        child: Text(AppLocalizations.of(context)!.packageRechargeViewDhiraaguFirstText,
                                                    ...
                                                    child: FadeTransition(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: CheckboxListTile(
                                                          title: Text(AppLocalizations.of(context)!.keepInfoSaved, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, fontFamily: 'Roboto'),),
                                                          value: _checked,
                                              ...
                                              Padding(
                                                ...
                                                child: SlideTransition(
                                                  ...
                                                  child: FadeTransition(
                                                    opacity: _animationController,
                                                    child: ButtonWidget(
                                                      buttonText: AppLocalizations.of(context)!.buyPackage,
                                                    ),
                                                  ),
                                                ),
                                              ),
                                              ...
                                              Padding(
                                                ...
                                                child: Align(
                                                    ...
                                                    child: SlideTransition(
                                                      ...
                                                      child: FadeTransition(
                                                        opacity: _animationController,
                                                        child: Text(AppLocalizations.of(context)!.packageRechargeViewOoredooFirstText,
                                                          style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Colors.grey.shade600),),
                                                      ),
                                                    )
                                                ),
