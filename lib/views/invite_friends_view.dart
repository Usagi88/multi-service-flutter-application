                                                ...
                                                child: FadeTransition(
                                                  ...
                                                  child: Container(
                                                      ...
                                                      child: TextButton.icon(
                                                          icon: Text(AppLocalizations.of(context)!.shareLink,style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w400),),
                                                          label: Icon(FontAwesomeIcons.share, color: Colors.white,),
                                                          onPressed: () {
