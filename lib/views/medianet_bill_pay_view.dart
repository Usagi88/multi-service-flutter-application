...
class MedianetBillPayView extends StatefulWidget {
  final bool? dhiraagu;
  final bool? ooredoo;
  MedianetBillPayView({Key? key,
    this.dhiraagu,
    this.ooredoo
  }) : super(key: key);

  @override
  _MedianetBillPayViewState createState() => _MedianetBillPayViewState();
}

class _MedianetBillPayViewState extends State<MedianetBillPayView> with SingleTickerProviderStateMixin{
                      ...
                      child: Container(
                        ...
                        child: SlideTransition(
                          ...
                          child: FadeTransition(
                            ...
                            child: Text(
                              AppLocalizations.of(context)!.medianetPayBillFirstText,
                              style: TextStyle(
                                  fontSize: 14.0,
                    ...
                    Padding(
                        ...
                        child: SlideTransition(
                          ...
                          child: FadeTransition(
                            opacity: _animationController,
                            child: WarningText(
                                warningText: AppLocalizations.of(context)!.medianetPayBillSecondText,
