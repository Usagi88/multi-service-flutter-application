                                    ...
                                    child: Row(
                                      children: [
                                        Text(AppLocalizations.of(context)!.details, style: TextStyle(
                                            ...
                                            fontWeight: FontWeight.w400),),
                                        Spacer(),
                                        Text('Medianet BillPay  (158414) Local IPTV', textAlign:TextAlign.left, style: TextStyle(
                                            fontSize: MediaQuery.of(context).size.width > 350 ? 14 : 12,
                                            fontWeight: FontWeight.w400,
                                            color: Colors.grey.shade600,
                                            fontFamily: 'Roboto'
                            ...
                            child: FadeTransition(
                              ...
                              child: Container(
                                  ...
                                  child: TextButton.icon(
                                      icon: Text(AppLocalizations.of(context)!.shareReceipt,style: TextStyle(
                                          color: Colors.white,
                          ...
                          child: SlideTransition(
                            ...
                            child: FadeTransition(
                              ...
                              child: Container(
                                  ...
                                  child: TextButton.icon(
                                      icon: Text(AppLocalizations.of(context)!.saveReceipt,style: TextStyle(
                                          color: Colors.white,
                                          fontSize: MediaQuery.of(context).size.width > 350 ? 14 : 11,
                                          fontWeight: FontWeight.w400),),
                                      label: Icon(
